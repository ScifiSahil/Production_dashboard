...
import { ChevronLeft, MessageCircle, X, Send } from 'lucide-react';
...
export default function HRDashboard() {
  ...
  const [chatMessages, setChatMessages] = useState([
    { id: 1, type: 'bot', text: 'Hi! 👋 I\'m your HR Assistant. Ask me about Headcount, Attrition, Training, or any HR metrics!' }
  ]);
  ...
  // Attrition Data
  const attritionKPIs = [
    { label: 'Period', value: '1st April, 23 TO 30th June, 23', color: 'bg-blue-600' },
  ...
  const COLORS = ['#0066cc', '#00a8cc', '#10b981', '#f59e0b', '#ef4444', '#8b5cf6', '#ec4899'];

  // Components
  const KPIBox = ({ label, value, color }) => (
    <div className={`${color} text-white rounded-lg p-4 text-center shadow-lg border-2 border-white`}>
  ...
  const ChartCard = ({ title, children, colspan = 1 }) => (
    <div className={`bg-white rounded-lg p-4 shadow-lg border-2 border-blue-400 ${colspan === 2 ? 'col-span-2' : ''}`}>
  ...
  const MetricCard = ({ label, value, subtext, bgColor }) => (
    <div className={`${bgColor} text-white rounded-lg p-4 text-center shadow-lg`}>
        ...
        <ChartCard title="Month wise trend" colspan={2}>
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={monthData}>
              ...
              <YAxis />
              <Tooltip />
              <Area type="monotone" dataKey="value" stroke="#0066cc" fill="url(#colorMonth)" />
            </AreaChart>
          </ResponsiveContainer>
        </ChartCard>
      </div>
    ...
    <div className="space-y-4">
      <div className="grid grid-cols-4 gap-3">
        {attritionKPIs.map((kpi, idx) => (
          <KPIBox key={idx} label={kpi.label} value={kpi.value} color={kpi.color} />
        ))}
      </div>

      <div className="bg-white rounded-lg p-4 shadow-lg border-2 border-blue-400">
        <h3 className="text-sm font-black text-gray-800 mb-3">Female Employees</h3>
          ...
          <ResponsiveContainer width="100%" height="100%">
            <PieChart>
              <Pie data={[
                ...
                {[0,1,2,3,4,5].map(idx => <Cell key={idx} fill={COLORS[idx]} />)}
              </Pie>
              <Tooltip />
            </PieChart>
          </ResponsiveContainer>
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-white rounded-lg p-4 shadow-lg border-2 border-blue-600">
          <h3 className="text-sm font-black text-white bg-blue-600 p-2 mb-3 rounded">OJT & CRT Training Data</h3>
          <table className="w-full text-sm mb-4">
            <thead className="bg-blue-100">
              <tr>
                <th colSpan="2" className="p-2 text-center border font-black">OJT</th>
                <th colSpan="2" className="p-2 text-center border font-black">CRT</th>
              </tr>
          ...
          <h3 className="text-sm font-black text-white bg-blue-600 p-2 mb-3 rounded">Safety Training Data</h3>
          <table className="w-full text-sm">
            <thead className="bg-blue-100">
              <tr>
        ...
        <div className="bg-white rounded-lg p-4 shadow-lg border-2 border-blue-600">
          <h3 className="text-sm font-black text-white bg-blue-600 p-2 mb-3 rounded">Skill Level</h3>
          <table className="w-full text-sm">
            <thead className="bg-blue-100">
              <tr>
          ...
          <p className="text-xs text-gray-600 mt-3 italic font-semibold">Action Plan: L2→L3 & L3→L4 conversion monthly. Identify weak areas.</p>
        </div>
      </div>
    </div>
  );
  ...
  const renderRecruitmentDetail = () => (
    <div className="space-y-4">
      <div className="grid grid-cols-4 gap-3">
        <MetricCard label="New Joined" value="175" subtext="Placed" bgColor="bg-green-500" />
        <MetricCard label="Time to Hire" value="30" subtext="Days" bgColor="bg-blue-600" />
        <MetricCard label="Offer Acceptance" value="High" subtext="Rate" bgColor="bg-green-500" />
        <MetricCard label="Quality Index" value="Good" subtext="Performance" bgColor="bg-purple-600" />
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-white rounded-lg p-4 shadow-lg border-2 border-red-400">
          ...
          <div className="space-y-2">
            <div className="flex justify-between"><span className="font-bold">Open Positions:</span><span className="font-black">12</span></div>
            <div className="flex justify-between"><span className="font-bold">In Process:</span><span className="font-black">8</span></div>
            <div className="flex justify-between"><span className="font-bold">Closed:</span><span className="font-black">175</span></div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-4 shadow-lg border-2 border-red-400">
          ...
          <div className="space-y-2">
            <div className="flex justify-between"><span className="font-bold">Avg Quality:</span><span className="font-black">8.5/10</span></div>
            <div className="flex justify-between"><span className="font-bold">Retention:</span><span className="font-black">94%</span></div>
            <div className="flex justify-between"><span className="font-bold">Cost/Hire:</span><span className="font-black">₹2.5K</span></div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-4 shadow-lg border-2 border-red-400">
          ...
          <div className="space-y-2">
            <div className="flex justify-between"><span className="font-bold">Referral:</span><span className="font-black">45%</span></div>
            <div className="flex justify-between"><span className="font-bold">Job Board:</span><span className="font-black">35%</span></div>
            <div className="flex justify-between"><span className="font-bold">Campus:</span><span className="font-black">20%</span></div>
          </div>
        </div>
      </div>
    </div>
  ...
  const renderCompensationDetail = () => (
    <div className="space-y-4">
      <div className="grid grid-cols-4 gap-3">
        <MetricCard label="Total Payroll" value="₹1.42M" subtext="Monthly" bgColor="bg-green-500" />
        <MetricCard label="Budget Variance" value="±2%" subtext="On Track" bgColor="bg-blue-600" />
        <MetricCard label="Avg per Emp" value="₹12,850" subtext="Monthly" bgColor="bg-purple-600" />
        <MetricCard label="Overtime Cost" value="Managed" subtext="Optimized" bgColor="bg-cyan-600" />
      </div>
        ...
        <ChartCard title="Budget vs Actual">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={costTrend}>
              ...
              <Tooltip formatter={(value) => `₹${value}K`} />
              <Legend />
              <Area type="monotone" dataKey="budget" stackId="1" fill="#8b5cf6" />
              <Area type="monotone" dataKey="actual" stackId="1" fill="#ef4444" />
            </AreaChart>
          </ResponsiveContainer>
        </ChartCard>
      </div>
      ...
      <div className="bg-white rounded-lg p-4 shadow-lg border-2 border-green-500">
        <h3 className="text-sm font-black text-white bg-green-600 p-2 mb-3 rounded">Benefits & Welfare Programs</h3>
        <div className="grid grid-cols-4 gap-4">
          ...
          <div className="p-3 bg-blue-50 rounded border-l-4 border-blue-500">
            ...
            <p className="text-sm font-semibold text-gray-600">15% Contribution</p>
          </div>
          <div className="p-3 bg-purple-50 rounded border-l-4 border-purple-500">
            <p className="font-black text-gray-800">Leave Benefits</p>
            <p className="text-sm font-semibold text-gray-600">20 Days Annual</p>
          </div>
          <div className="p-3 bg-orange-50 rounded border-l-4 border-orange-500">
            <p className="font-black text-gray-800">Bonus Structure</p>
            <p className="text-sm font-semibold text-gray-600">Performance Based</p>
          </div>
        </div>
      </div>
    </div>
  ...
  const renderEngagementDetail = () => (
    <div className="space-y-4">
      <div className="grid grid-cols-4 gap-3">
        <MetricCard label="Engagement Score" value="8.4" subtext="Out of 10" bgColor="bg-green-500" />
        <MetricCard label="Participation" value="156" subtext="1:1 Meetings" bgColor="bg-blue-600" />
        <MetricCard label="Appreciation" value="287" subtext="Recognition" bgColor="bg-purple-600" />
        <MetricCard label="Satisfaction" value="92%" subtext="Survey Rate" bgColor="bg-cyan-600" />
      </div>
        ...
        <ChartCard title="Engagement Trend">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={engagementTrend}>
              ...
              <YAxis domain={[0, 10]} />
              <Tooltip />
              <Line type="monotone" dataKey="score" stroke="#0066cc" strokeWidth={3} />
            </LineChart>
          </ResponsiveContainer>
        </ChartCard>
      </div>

      <ChartCard title="Participation Trend (Meetings & Appreciation)" colspan={1}>
        <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="bg-white rounded-lg p-4 shadow-lg border-2 border-pink-500">
        <h3 className="text-sm font-black text-white bg-pink-600 p-2 mb-3 rounded">Engagement Initiatives</h3>
        <div className="grid grid-cols-3 gap-4">
          <div className="p-3 bg-pink-50 rounded border-l-4 border-pink-500">
            <p className="font-black text-gray-800">Team Events</p>
            <p className="text-sm font-semibold text-gray-600">Monthly celebrations & outings</p>
          </div>
          <div className="p-3 bg-blue-50 rounded border-l-4 border-blue-500">
            <p className="font-black text-gray-800">Wellness Program</p>
            <p className="text-sm font-semibold text-gray-600">Health & fitness activities</p>
          </div>
          <div className="p-3 bg-green-50 rounded border-l-4 border-green-500">
            <p className="font-black text-gray-800">Feedback Loop</p>
            <p className="text-sm font-semibold text-gray-600">Quarterly engagement surveys</p>
          </div>
        </div>
      </div>
    </div>
  ...
  const renderInitiativesDetail = () => (
    <div className="space-y-4">
      <div className="grid grid-cols-4 gap-3">
        <MetricCard label="Young Leaders" value="12" subtext="Selected" bgColor="bg-blue-600" />
        <MetricCard label="Six Sigma" value="5" subtext="Projects" bgColor="bg-green-500" />
        <MetricCard label="Skill/Will" value="100%" subtext="Completion" bgColor="bg-purple-600" />
        <MetricCard label="Role Expansion" value="28" subtext="Employees" bgColor="bg-orange-500" />
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <ChartCard title="Young Leaders Readiness">
          <ResponsiveContainer width="100%" height="100%">
            <PieChart>
              <Pie data={youngLeadersData} cx="50%" cy="50%" outerRadius={80} dataKey="count" label>
                {[0,1,2].map(idx => <Cell key={idx} fill={COLORS[idx]} />)}
              </Pie>
              <Tooltip />
              <Legend />
            </PieChart>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-white rounded-lg p-4 shadow-lg border-2 border-blue-600">
          <h3 className="text-sm font-black text-white bg-blue-600 p-2 mb-3 rounded">Young Leaders Program</h3>
          <table className="w-full text-sm">
            <thead className="bg-blue-100">
              <tr>
            ...
            <tbody>
              <tr className="border-b hover:bg-blue-50">
                ...
                <td className="p-2 border text-center font-bold text-green-600">✓ Active</td>
              </tr>
              <tr className="border-b hover:bg-blue-50">
                <td className="p-2 border font-bold">6-12 months</td>
                <td className="p-2 border text-center font-black">5</td>
                <td className="p-2 border text-center font-bold text-orange-600">→ Pipeline</td>
              </tr>
              <tr className="hover:bg-blue-50">
                <td className="p-2 border font-bold">1-2 years</td>
                <td className="p-2 border text-center font-black">4</td>
                <td className="p-2 border text-center font-bold text-blue-600">○ Develop</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="bg-white rounded-lg p-4 shadow-lg border-2 border-orange-500">
          <h3 className="text-sm font-black text-white bg-orange-600 p-2 mb-3 rounded">Skill Development Programs</h3>
          <div className="space-y-3">
            <div className="p-3 bg-orange-50 rounded border-l-4 border-orange-500">
              <p className="font-black text-gray-800">Skill/Will Matrix</p>
              <p className="text-sm font-semibold text-gray-600">100% Coverage Completed</p>
            </div>
            <div className="p-3 bg-green-50 rounded border-l-4 border-green-500">
              <p className="font-black text-gray-800">Functional Expertise</p>
              <p className="text-sm font-semibold text-gray-600">18 Specialists Identified</p>
            </div>
            <div className="p-3 bg-blue-50 rounded border-l-4 border-blue-500">
              <p className="font-black text-gray-800">Role Expansion</p>
              <p className="text-sm font-semibold text-gray-600">28 Employees Growth Ready</p>
            </div>
          </div>
        </div>
      </div>
  ...
  const renderSummaryDetail = () => (
    <div className="space-y-4">
      <div className="grid grid-cols-4 gap-3">
        <MetricCard label="Female Diversity" value="53" subtext="5% of HC" bgColor="bg-pink-500" />
        <MetricCard label="Net Growth" value="+71" subtext="Joined - Exit" bgColor="bg-green-500" />
        <MetricCard label="Training Growth" value="+115%" subtext="vs Target" bgColor="bg-blue-600" />
        <MetricCard label="Engagement" value="8.4/10" subtext="Score" bgColor="bg-purple-600" />
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <ChartCard title="Workforce Diversity">
          <ResponsiveContainer width="100%" height="100%">
            <PieChart>
              <Pie data={diversityData} cx="50%" cy="50%" outerRadius={80} dataKey="value" label>
                {[0,1,2,3].map(idx => <Cell key={idx} fill={COLORS[idx]} />)}
              </Pie>
              <Tooltip />
              <Legend />
            </PieChart>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-white rounded-lg p-4 shadow-lg border-2 border-pink-500">
          <h3 className="text-sm font-black text-white bg-pink-600 p-2 mb-3 rounded">Diversity & Inclusion Metrics</h3>
          <div className="space-y-2">
        ...
        <div className="bg-white rounded-lg p-4 shadow-lg border-2 border-green-500">
          <h3 className="text-sm font-black text-white bg-green-600 p-2 mb-3 rounded">Key Achievements</h3>
          <ul className="space-y-2">
            <li className="p-2 bg-green-50 border-l-4 border-green-500 font-semibold">✓ +71 Net growth in headcount</li>
            <li className="p-2 bg-blue-50 border-l-4 border-blue-500 font-semibold">✓ Training +115% vs target</li>
            <li className="p-2 bg-purple-50 border-l-4 border-purple-500 font-semibold">✓ Engagement score 8.4/10</li>
            <li className="p-2 bg-orange-50 border-l-4 border-orange-500 font-semibold">✓ Attrition rate under control</li>
            <li className="p-2 bg-pink-50 border-l-4 border-pink-500 font-semibold">✓ 12 Young Leaders developed</li>
          </ul>
        </div>
      </div>
    </div>
  ...
  const renderOverviewPage = () => (
    <div className="w-full h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex flex-col overflow-hidden">
      <div className="bg-white border-b-4 border-blue-600 shadow-lg px-4 py-3 flex-shrink-0">
        <h1 className="text-3xl font-black text-blue-600">KALYANI TECHNOFORGE - HR Dashboard</h1>
        <p className="text-sm text-gray-600 font-semibold">Comprehensive People Intelligence Platform</p>
      </div>
          ...
          {[
            {
              ...
              metrics: [
                ...
                { label: 'Gender Equality %', value: '5%', subtext: '(53 Female)' }
              ]
            },
            {
              id: 'recruitment',
            ...
            },
            {
              ...
              metrics: [
                ...
                { label: 'Payroll Variance', value: '±2%', subtext: '(On Track)' },
            ...
            },
            {
              ...
              progress: 115,
              metrics: [
                { label: 'Training Hrs/Employee (P vs A)', value: '48 hrs', subtext: '(Target: 40 hrs)' },
            ...
            },
            {
              ...
              progress: 91,
              metrics: [
                { label: 'Diversity Index', value: '53 (5%)', subtext: 'Female employees' },
            ...
            >
              <div className="p-4">
                ...
                <div className="flex items-start justify-between mb-2">
                  <div>
                    <h3 className="font-black text-gray-900 text-xs">{card.title}</h3>
                    <p className="text-xs text-gray-600 font-semibold">{card.subtitle}</p>
                  </div>
                  <div className={`${card.headerBg} text-white text-xs font-black px-2 py-1 rounded-full`}>✓ On Track</div>
                </div>

                {/* Main value */}
                <h2 className={`text-3xl font-black ${card.mainColor} mb-3`}>{card.mainValue}</h2>
                  ...
                  {card.metrics.map((metric, idx) => (
                    <div key={idx} className="flex justify-between items-start text-xs">
                      ...
                      <div className="text-right">
                        <span className="font-black text-gray-900">{metric.value}</span>
                        {metric.subtext && <p className="text-gray-600 text-xs">{metric.subtext}</p>}
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="mt-3">
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className={`text-xs font-black ${card.mainColor}`}>{card.progress}%</span>
                  </div>
                  <div className="w-full h-2 bg-gray-300 rounded-full overflow-hidden">
                    <div 
                      className={`h-full transition-all rounded-full ${
                        card.mainColor === 'text-blue-600' ? 'bg-blue-600' :
                        card.mainColor === 'text-red-600' ? 'bg-red-600' :
                        card.mainColor === 'text-green-600' ? 'bg-green-600' :
                        card.mainColor === 'text-cyan-600' ? 'bg-cyan-600' :
                        card.mainColor === 'text-orange-600' ? 'bg-orange-600' :
                        card.mainColor === 'text-pink-600' ? 'bg-pink-600' :
                        card.mainColor === 'text-purple-600' ? 'bg-purple-600' :
                        'bg-teal-600'
                      }`}
    ...
    return (
      <div className="w-full h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex flex-col overflow-hidden">
        <div className="bg-white border-b-4 border-blue-600 shadow-lg px-6 py-4 flex-shrink-0 flex items-center justify-between">
          ...
          <div className="text-right">
            <p className="text-sm text-gray-600 font-bold">KALYANI TECHNOFORGE</p>
          ...
          {selectedCard === 'compliance' && (
            <div className="space-y-4">
              <div className="grid grid-cols-5 gap-3">
                <MetricCard label="Statutory" value="100%" subtext="Compliant" bgColor="bg-green-500" />
                <MetricCard label="Audits" value="11" subtext="Active" bgColor="bg-blue-600" />
                <MetricCard label="POSH Training" value="Active" subtext="Mandatory" bgColor="bg-purple-600" />
                <MetricCard label="Safety Hours" value="339" subtext="Coverage" bgColor="bg-orange-500" />
                <MetricCard label="Programs" value="45" subtext="Total" bgColor="bg-cyan-600" />
              </div>

              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white rounded-lg p-4 shadow-lg border-2 border-green-500">
                  <h3 className="text-sm font-black text-white bg-green-600 p-2 mb-3 rounded">Compliance Checklist</h3>
                  <ul className="space-y-2">
                    <li className="p-2 bg-green-50 border-l-4 border-green-500 font-semibold">✓ All Statutory Requirements</li>
                    <li className="p-2 bg-green-50 border-l-4 border-green-500 font-semibold">✓ ENY & Customer Audits</li>
                    <li className="p-2 bg-blue-50 border-l-4 border-blue-500 font-semibold">→ POSH Compliance Training</li>
                    <li className="p-2 bg-green-50 border-l-4 border-green-500 font-semibold">✓ Safety Performance Tracking</li>
                    <li className="p-2 bg-green-50 border-l-4 border-green-500 font-semibold">✓ 100% Safety Training Coverage</li>
                  </ul>
                </div>

                <div className="bg-white rounded-lg p-4 shadow-lg border-2 border-green-500">
                  <h3 className="text-sm font-black text-white bg-green-600 p-2 mb-3 rounded">HR Initiatives</h3>
                  <div className="space-y-2">
    ...
    <div className="w-screen h-screen bg-gray-100 overflow-hidden">
      ...
      {showChat && (
        <div className="fixed bottom-6 right-6 w-96 h-[600px] bg-white border-4 border-blue-600 rounded-lg shadow-2xl flex flex-col overflow-hidden z-50">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            {chatMessages.map(msg => (
              <div key={msg.id} className={`flex ${msg.type === 'user' ? 'justify-end' : 'justify-start'}`}>
                <div className={`max-w-xs px-4 py-2 rounded-lg text-sm font-semibold ${
                  msg.type === 'user'
          ...
          <form onSubmit={handleChatSubmit} className="border-t p-4 bg-gray-50 flex-shrink-0">
