...
const themes = {
  dark: {
    ...
    headerBg:
      "linear-gradient(90deg, rgba(10, 37, 64, 0.95) 0%, rgba(30, 90, 168, 0.95) 100%)",
    text: "#e2e8f0",
    ...
    >
      ...
      >
        ...
        <nav style={{ display: "flex", gap: "0.5rem", alignItems: "center" }}>
          ...
          <a
            href="https://ktfrancesrv2.kalyanicorp.com/kalyani.iot/exim"
            target="_blank"
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
          <svg width="35" height="35" viewBox="0 0 50 50">
            ...
            />
            <path
              d="M15 25 L25 15 L35 25 L25 35 Z"
              fill={currentTheme.accent}
            />
          </svg>
          <span
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
          <span style={{ color: "#cbd5e1", fontSize: "0.85rem" }}>
            © 2025 Purchase Dashboard System
          </span>
  ...
  return (
    <div
      style={{
        ...
        padding: "1.25rem",
        border: `1px solid ${
          isHovered ? currentTheme.borderHover : currentTheme.border
        }`,
        boxShadow: isHovered
          ? `0 8px 25px ${
              theme === "dark"
...
const AIChatbot = ({ theme }) => {
  ...
  const [messages, setMessages] = useState([
    {
      type: "ai",
      text: "Hello! I'm your AI assistant. Ask me anything about the Purchase Dashboard data.",
    },
  ]);
...
const PurchaseDashboard = () => {
  ...
  const packagingData =
    timeframe === "monthly"
      ? dashboardData.packaging.monthly
      : dashboardData.packaging.weekly;
    ...
    >
      ...
      >
        ...
        >
            ...
            <div style={{ display: "flex", gap: "1rem", alignItems: "center" }}>
              ...
              <div style={{ flex: 1, height: "200px" }}>
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart
                    data={dashboardData.subcon.cost.slice(0, 2).map((d) => ({
                      ...d,
                      value: d.category === "Budget" ? 100 : 80,
                    }))}
                  >
                    <CartesianGrid
                      strokeDasharray="3 3"
          ...
          {/* Aluminium Prices */}
          <DashboardCard
            title="📊 Aluminium Price Trend (USD/MT)"
            theme={theme}
            span={4}
          >
          ...
          {/* Packaging */}
          <DashboardCard
            title="📦 Packaging - Plan vs Actual (₹ Cr)"
            theme={theme}
            span={4}
          >
            <div style={{ height: "200px" }}>
            ...
            >
              ...
              <tbody>
                {dashboardData.stores.audits.map((audit, idx) => (
                  ...
                  >
                    <td style={{ padding: "0.5rem", color: currentTheme.text }}>
                      {audit.subcon}
                    </td>
                    <td style={{ padding: "0.5rem", color: currentTheme.text }}>
                      {audit.planned}
          ...
          <DashboardCard title="🚀 Project Status" theme={theme} span={3}>
            ...
            >
              <span style={{ color: currentTheme.success }}>8 On Track</span> |{" "}
              <span style={{ color: currentTheme.danger }}>2 Delayed</span>
            </div>
          </DashboardCard>

          {/* Customer Feedback */}
          <DashboardCard
            title="💬 Internal Customer Feedback"
            theme={theme}
            span={6}
          >
